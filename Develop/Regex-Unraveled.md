...
**Description:** This regex matches the word "Hello" only if it appears at the beginning of a line.
...
**Description:** This regex matches one or more occurrences of the letter "a" in the text.
